...
from source_hubspot_history_deals.streams import API
...
def config_fixture():
    return {"start_date": "2023-07-05T00:00:00Z", "credentials": {"credentials_title": "Private App Credentials", "access_token": "test_access_token"}}
