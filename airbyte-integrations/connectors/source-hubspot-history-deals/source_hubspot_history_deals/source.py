...
class HubspotHistoryDealsStream(HttpStream, ABC):
    """
    ...
    `class HubspotHistoryDealsStream(HttpStream, ABC)` which is the current class
    `class Customers(HubspotHistoryDealsStream)` contains behavior to pull data for customers using v1/customers
    `class Employees(HubspotHistoryDealsStream)` contains behavior to pull data for employees using v1/employees

    If some streams implement incremental sync, it is typical to create another class
    `class IncrementalHubspotHistoryDealsStream((HubspotHistoryDealsStream), ABC)` then have concrete stream implementations extend it. An example
    is provided below.
...
class Customers(HubspotHistoryDealsStream):
    """
...
class IncrementalHubspotHistoryDealsStream(HubspotHistoryDealsStream, ABC):
    """
...
class Employees(IncrementalHubspotHistoryDealsStream):
    """
    TODO: Change class name to match the table/data source this stream corresponds to.
    """
...
# Source
class SourceHubspotHistoryDeals(AbstractSource):
