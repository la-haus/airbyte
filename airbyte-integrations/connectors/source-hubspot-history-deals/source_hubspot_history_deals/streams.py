...
from source_hubspot_history_deals.constants import OAUTH_CREDENTIALS, PRIVATE_APP_CREDENTIALS
from source_hubspot_history_deals.errors import HubspotAccessDenied, HubspotInvalidAuth, HubspotRateLimited, HubspotTimeout, InvalidStartDateConfigError
from source_hubspot_history_deals.helpers import APIv1Property, APIv3Property, GroupByKey, IRecordPostProcessor, IURLPropertyRepresentation, StoreAsIs
...
class PropertyHistory(Stream):
    """Deals Endpoint, API v1
    Is used to get all deals and the history of their respective
    ...
    #https://api.hubapi.com/properties/v2/deals/properties --sale
